...
function preload(){
  ...
  retryImage = loadImage("lol/retry.png")
  houseImage = loadImage("lol/house1.png")
  backgroundMusic = loadSound("lol2/backgroundMusic.mp3")
}
...
function setup(){
  ...
  retry.addImage("retry", retryImage)
  retry.scale = 0.2
  retry.visible = false
